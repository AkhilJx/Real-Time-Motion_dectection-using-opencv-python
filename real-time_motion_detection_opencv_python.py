...
while cap.isOpened():
    ...
    if contours:
        ...
        for contour in contours:
            ...
            # cv2.putText(frame1, "Status: {}".format('Movement Detected'), (10, 40), cv2.FONT_HERSHEY_SIMPLEX,
            #             1, (0, 0, 255), 3)
    ...
    cv2.putText(image, 'Press ESC to Quit ', (300, 120), cv2.FONT_HERSHEY_SIMPLEX, 2,
